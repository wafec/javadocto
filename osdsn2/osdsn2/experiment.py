...
def experiment_transition_target(test_case, test_summary, target_transition, ignore_injection):
    ...
    try:
        ...
        if not ignore_injection:
            default_driver.set_max_waiting_use(default_driver.get_max_waiting() + 10)
            ...
            for i, message_number, body, param in random.sample(params, k):
                ...
                while mutation_select.has_mutations():
                    def callback(i, new_message_number, new_body):
                        ...
                        LOGGER.info('Callback %i == %i', new_message_number, message_number)
                        if message_number == new_message_number:
                            LOGGER.info('Callback mutation starting ...')
...
if __name__ == '__main__':
    ...
    def func_parser_a(args):
        experiment_transition_target(args.test_case, args.test_summary, args.target_transition, args.ignore_injection)
