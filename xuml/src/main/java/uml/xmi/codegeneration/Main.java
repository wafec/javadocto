...
public class Main {
    public static void main(String... args) throws FileNotFoundException {
        ModelDocument modelDocument = new ModelDocument(new FileInputStream(new File("C:\\Users\\wallacec\\workspace-papyrus\\test_vendingmachine\\test_vendingmachine.uml")));
